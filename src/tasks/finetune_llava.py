...
either: python src/tasks/finetune_llava.py --mode lora
        python src/tasks/finetune_llava.py --mode full
"""
...
def finetune_llava(mode="lora"):
    ...
    data_path = f"{project_root}/data/processed/llava_format_prompt2/train.json"
    image_folder = f"{project_root}/data/processed/images"
    output_dir = f"{project_root}/checkpoints/llava-med_{mode}_prompt2NL"
